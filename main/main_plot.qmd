...
1.  证据1: 北京人口密度分布差异较大？，人们可能需要跨城出行，路会很（直线距离上的远）
    ...
    -   商业资源和人口分布的错配 [人口密度04 人口密度和商业资源的错配]
...
#add icon
add_icons <- function(file) {
  image_read(glue('plot/{file}.png'))   |> 
  image_composite(icon2,
                   gravity = "center",
                   offset = "+0+0",
                   operator = "dissolve",
                   compose_args="30%") |>  
  image_annotate("Data Source: AMAP, OSM",
                   gravity = "southwest",
                   location = "+100+210",
                   font = "El Messiri",
                   color = "gray30",
                   size = 80) |> 
  image_annotate("Graphic by ",
                   gravity = "southwest",
                   location = "+100+110",
                   font = "El Messiri",
                   color = "gray30",
  ...
  image_composite(icon1,
                   ...
                   operator = "dissolve",
                   compose_args="90%") |>  
  image_write(glue('plot/{file}_icon.png'))
}

add_icons_line <- function(file) {
  image_read(glue('plot/{name}.png'))   |> 
  image_composite(icon2,
                   gravity = "center",
                   offset = "+0+0",
                   operator = "dissolve",
  ...
  image_composite(icon1,
                   ...
                   operator = "dissolve",
                   compose_args="90%") |>  
  image_write(glue('plot/{name}_icon.png'))
}
